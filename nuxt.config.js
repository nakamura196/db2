...
const commonEnv = require(`./env/common.ts`)
for (const key in commonEnv) {
  env[key] = commonEnv[key]
}

const norm = JSON.parse(fs.readFileSync(env.norm))
env.itaiji = norm
...
const siteDesc = env.siteDesc
const siteKeywords = env.keywords || []
